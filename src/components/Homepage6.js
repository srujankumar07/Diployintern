export default function Homepage6() {
  return (
    <div className="w-full p-4 md:p-16">
      <div className="bg-green-100 p-8 md:p-12 rounded-3xl mb-4 relative overflow-hidden">
        <div className="flex flex-col md:flex-row p-6 md:p-12 justify-between items-center z-10 relative">
      ...
      <div className="px-4 md:px-0">
        <div className="max-w-4xl mx-auto p-4 md:p-8">
          <div className="flex flex-col md:flex-row items-center">
            {/* Heading */}
            <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4 md:mb-0 md:mr-6">
